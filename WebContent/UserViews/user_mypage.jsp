   ...
   <body>
	   <div id="container">
		   ...
		   <main>
		     <section>
			   <ul id="content">
				   <li class="list"><a href="../UserViews/user_profile_search.jsp">MY PROFILE</a></li>
				   <li class="list"><a href="../UserViews/user_update_search.jsp">UPDATE MY PROFILE</a></li>
				   <li class="list"><a href="#">INFORMATION</a></li>
				   <li class="list"><a href="../UserViews/user_logout.jsp">LOGOUT</a></li>
			   </ul>
			 </section>
			   <!--/main-->
		   </main>
