	...
	<table class="design">
		<tr>
			...
			<td class="input"><input type="text" name="name" size="15"
				value="${uub.name }" maxlength="32"></td>
		</tr>

		<tr>
			<th class="content">■GENDER</th>
			<td class="input">男 <input type="radio" name="sex" value="1">
		...
		<tr>
			...
			<td class="input"><input type="text" name="job" size="30"
				value="${uub.job }" maxlength="32"></td>
		</tr>

		<tr>
			<th class="content">■PHONE NUMBER</th>
			<td class="input"><input type="tel" name="phone_number"
				value="${uub.phone_number }"></td>
		</tr>

		<tr>
			<th class="content">■MAIL ADDRESS</th>
			<td class="input"><input type="text" name="mail_address"
				value="${uub.mail_address }" size="30"></td>
		</tr>

		<tr>
			<th class="content">■PASSWORD</th>
			<td class="input"><input type="password" name="password"
				value="${uub.password }" maxlength="20">
	</table>
